...
> [!NOTE]
> Deprecated 
> 'Microsoft.Azure.Services.AppAuthentication` is replaced by new authentication library 'azure.identity.DefaultAzureCredential' available for .NET, Java, TypeScript and Python and should be used with any new development. More information can be found here: [Authentication and the Azure SDK](https://azure.github.io/azure-sdk/posts/2020-02-25/defaultazurecredentials.html)
